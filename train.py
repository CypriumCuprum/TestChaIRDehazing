...
def _train(model, args):
    ...
    for epoch_idx in range(epoch, args.num_epoch + 1):
        ...
        for iter_idx, batch_data in enumerate(dataloader):
            ...
            if eval_now > 0 and iter_idx % eval_now == 0 and iter_idx > 0 and (epoch_idx > 20 or epoch_idx == 1):
                ...
                if val_gopro >= best_psnr:
                    torch.save({'model': model.state_dict(), 'epoch': epoch_idx, 'optimizer': optimizer.state_dict()},
